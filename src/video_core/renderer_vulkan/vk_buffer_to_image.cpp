...
namespace Vulkan {
BufferToImageConverter::BufferToImageConverter(Instance& vk_inst) : vk_inst{vk_inst} {
...
void BufferToImageConverter::ImageFromBuffer(vk::Buffer buffer, vk::Image image,
